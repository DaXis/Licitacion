...
public class ForceCloseCatch implements Thread.UncaughtExceptionHandler {

    private Context context;
    private static Context context1;

    public ForceCloseCatch(Context ctx) {
        context = ctx;
        context1 = ctx;
    }
    ...
    public void uncaughtException(Thread t, Throwable e) {
        try {
            ...
            Log.e(ForceCloseCatch.class.getName(),
                    "Error while sendErrorMail" + report);
            TextFileMannager.generateNoteOnSD("Error.txt", report.toString());
    ...
    /*public void sendErrorMail(final StringBuilder errorContent) {
        ...
        new Thread() {
            ...
            public void run() {
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                Intent sendIntent = new Intent(
                                        Intent.ACTION_SEND);
                                String subject = "Error en Red ciudadana";
                                ...
                                sendIntent.putExtra(Intent.EXTRA_EMAIL,
                                        new String[] { "daxis.garcia@gmail.com" });
                ...
                builder.setMessage("Ocurrió un error, mándanos el reporte para resolverlo a la brevedad.");
                builder.show();
                Looper.loop();
            }
        }.start();
